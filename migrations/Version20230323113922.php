 ...
 */
final class Version20230323113922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liaison (id INT AUTO_INCREMENT NOT NULL, secteur_id INT DEFAULT NULL, port_depart_id INT DEFAULT NULL, port_arrive_id INT DEFAULT NULL, duree TIME NOT NULL, INDEX IDX_225AC379F7E4405 (secteur_id), INDEX IDX_225AC3794C9CCD3 (port_depart_id), INDEX IDX_225AC37CEC9B4D0 (port_arrive_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
