 ...
 */
final class Version20230316084623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tarifer (id INT AUTO_INCREMENT NOT NULL, periode_id INT DEFAULT NULL, type_id INT DEFAULT NULL, tarif VARCHAR(255) NOT NULL, INDEX IDX_6904C4FFF384C1CF (periode_id), INDEX IDX_6904C4FFC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
